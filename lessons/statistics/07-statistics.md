...
>"What is the probability that Elvis was an identical twin, given that he had a twin brother?" can be stated as *P(ident | twin brother)*, which can be re-written using Bayes' Theorem:
>
>*P(ident | twin brother) = P(ident)P(twin brother | ident) / P(twin brother)*
>
>*P(twin brother)* is most tricky, so I started there. I admit I needed a little Google help to figure out that this is the sum of the probability that identical twins are brothers and fraternal twins are brothers. Identical twins are always the same gender, so *P(ident)P(brothers) = 1/300 \* 1/2*. For fraternal twins, both twins being boys is 1 of 4 outcomes so *P(frat)P(brothers) = 1/125 \* 1/4*
>
>That gives us the final solution of *P(ident | twin brother) = (1/300 \* 1/2) / (1/300 \* 1/2 + 1/125 \* 1/4) = 5/11* 
